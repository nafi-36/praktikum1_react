            ...
            <div className="container mt-3">
                <div className="card">
                    ...
                    <div className="card-body">
                        <form onSubmit={this.handlerSubmit}>
                            <div className="row mt-3">
                                ...
                                <div className="col-8">
                                    <input className="form-control" name="nominal" type="number" value={this.state.nominal} onChange={this.handlerChange} />
                                </div>
                            </div>
                            <div className="row mt-3">
                                <div className="col-4">
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-8">
                                    <select className="form-select" name="periode" aria-label="Default select example" onChange={this.handlerChange} required>
                                        <option></option>
                    ...
                    <div className="card-footer">
                        ...
                        <button className="w-100 alert alert-primary" name="result">{this.state.hasil}</button>
                    </div>
                </div>
            </div>
        )
